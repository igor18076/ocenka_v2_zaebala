...
window.ObjectScreen = function ObjectScreen({ onBack, onNavigate }) {
  ...
  return (
    <div>
      ...
      <PageHead title={o.title} subtitle={o.address}
        actions={[
          <Button key="e" variant="secondary" iconLeft={<Icon n="pencil" size={16} />}>Редактировать</Button>,
          ...
          <Card noBodyPad>
            <div style={{ padding: '6px 16px 0' }}>
              <Tabs value={tab} onChange={setTab} items={[
                ...
                { value: 'docs', label: 'Документы', count: o.docs.length },
            ...
            <div style={{ padding: 24 }}>
              ...
              {tab === 'docs' ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  <button style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '12px', border: '1.5px dashed var(--border-default)', borderRadius: 'var(--radius-md)', background: 'transparent', color: 'var(--text-muted)', cursor: 'pointer', fontFamily: 'var(--font-sans)', fontSize: 'var(--text-sm)', fontWeight: 600 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <Card title="Готовность к отчету">
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <Button variant="accent" block iconLeft={<Icon n="file-check" size={16} />} onClick={() => onNavigate('report')}>Сформировать отчет</Button>
            </div>
          </Card>
        </div>
      </div>
