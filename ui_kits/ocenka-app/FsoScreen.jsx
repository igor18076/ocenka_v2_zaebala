...
window.FsoScreen = function FsoScreen({ onNavigate }) {
  ...
  return (
    <div>
      <PageHead title="Проверка ФСО" subtitle="Соответствие отчета федеральным стандартам оценки"
        actions={<Button variant="primary" iconLeft={<Icon n="refresh-cw" size={16} />}>Перепроверить</Button>} />
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 20, alignItems: 'start' }}>
        ...
        <Card>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: 14, padding: '8px 4px' }}>
            ...
            <Button variant="accent" block disabled={pct !== 100} iconLeft={<Icon n="file-check" size={16} />} onClick={() => onNavigate('report')}>
              Сформировать отчет
            </Button>
          </div>
        </Card>
