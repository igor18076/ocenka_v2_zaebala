  ...
  return (
    <aside style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 11, padding: '18px 20px 16px' }}>
        <img src="../../assets/mark.svg" alt="" style={{ width: 34, height: 34 }} />
        <div style={{ lineHeight: 1 }}>
          <div style={{ fontSize: 17, fontWeight: 800, color: '#fff', letterSpacing: '-.01em' }}>Оценка<span style={{ color: '#5DC393' }}> PRO</span></div>
